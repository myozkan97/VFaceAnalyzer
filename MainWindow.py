...
def analyze_video(progress_callback):
    ...
    print_line("lksdjflakdsjhfalsd")
    print_line("ksjhfksdjhfksdjfhskdjfhskdjfhsdkjfh")

    print_line("Starting real-time video analyzer...")
    ...
    frame = 0
    frame_width = 480
    print_line("Started real-time video analyzer...")
            ...
            for (x, y, w, h) in faces:
                if w > frame_width / 10:
                    ...
                    try:
                        ...
                        Classifier.save_picture(detected_10margin_face, frame, apparent_age, gender, emotion_prediction)
    ...
    print_line("Classifying saved images, please wait...")
    Classifier.classify_and_folder_faces()

    print_line("Generating report, please wait...")
    total_number_of_images, person_dictionary = Classifier.analyze_classified_folders()

    #clean_textbox()
    print_line(Classifier.create_report(total_number_of_images, person_dictionary))
